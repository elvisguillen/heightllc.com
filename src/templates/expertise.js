                      ...
                      <Row>
                        <Col className='page-link-container' xs={{size: 12}} md={{size: 12}}>
                          <div className='page-accordion-link'>
                            ...
                            <button className="subheader-button" onClick={this.toggle} data-event={expertise.id}>{this.state.collapse === expertise.id ? '⊖' : '⊕'}</button>
                          </div>
                        </Col>
                      </Row>
                            ...
                            <Col className='page-copy' xs={{size: 12}} md={{size: 8}}>
                              ...
                              {expertise.title === 'Research' ? 
                                <div className='height-tags'>
                                  <Link className='height-tag' to='/tags/healthcare' >Healthcare</Link>     
                                  <Link className='height-tag' to='/tags/financial-services' >Financial Services</Link>
                                  <Link className='height-tag' to='/tags/special-situations' >Special Situations</Link>
